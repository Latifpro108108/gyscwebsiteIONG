...
const DEFAULT_TEXTS = [
  ...
  },
  {
    ...
    section: "about",
    value: "In 2025, nine young people from across the globe came together in South Korea. Over five days of intensive dialogue, they drafted a bold policy document — and laid the foundations for the Global Youth Sustainability Council.",
  },
  {
    key: "about_p2",
    label: "About — Paragraph 2",
    section: "about",
    value: "The co-founders authored the Eunpyeong Declaration — a 95-page framework addressing education, climate, inequality, and institutional reform.",
  },
  {
    key: "about_p3",
    label: "About — Paragraph 3",
    section: "about",
    value: "Registered as a Canadian NGO, GYSC now operates across 14 countries — empowering young people to participate meaningfully in global decisions.",
  },
  ...
  { key: "pillar_2_body", label: "Pillar 2 — Description", section: "pillars", value: "We create pathways for young people to hold real decision-making roles at local, national, and international levels." },
